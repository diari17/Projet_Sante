                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="specialite" class="form-control" required>
                                ...
                                <option value="chirurgie_cardio">Chirurgie cardio-thoracique</option>
                                <option value="neurochirurgie">Neurochirurgie</option>
                                <option value="orthopedie">Orthopédie-traumatologie</option>
                                <option value="plastique">Chirurgie plastique</option>
                                <option value="maxillo">Chirurgie maxillo-faciale</option>
                                <option value="pediatrie">Chirurgie pédiatrique</option>
                                <option value="viscérale">Chirurgie viscérale</option>
